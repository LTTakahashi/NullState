...
from core.models import Model2Config, train_model2, _domain_predictability
from core.metrics import score_embedding
...
OUT = os.environ.get("ALIGN_OUT", result("alignment.csv"))
