...
from core.models import Model2Config, train_model2, vae_diagnostics
from core.metrics import score_embedding, mcc, cca_score
...
OUT = os.environ.get("STAGE4_OUT", result("main_sweep_pilot.csv"))
