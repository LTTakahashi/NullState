...
from core.dgp_rotated import RotBasisConfig, generate
from core.models import Model2Config, train_model2
from core.metrics import score_embedding, cca_score, mcc
...
N, EPOCHS = 1500, 120
OUT = os.environ.get("BR_OUT", result("basis_rotation.csv"))
