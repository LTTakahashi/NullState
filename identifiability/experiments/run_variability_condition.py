...
from core.dgp import DGP2Config, _cached_reference, FIXED_STRUCTURE_SEED
from core.models import Model2Config, train_model2
from core.metrics import cca_score, mcc

N_ENVS = [2, 3, 5, 9]
SEEDS = [int(x) for x in os.environ.get("VC_SEEDS", ",".join(map(str, range(12)))).split(",")]
N, EPOCHS = 1500, 150
OUT = os.environ.get("VC_OUT", result("variability_condition.csv"))
